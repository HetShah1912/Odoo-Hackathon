...
import { Wrench, User, Calendar, DollarSign, AlertCircle, FileText, Save, Package, Zap } from "lucide-react"
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[95vh] overflow-hidden border-2 border-primary/30 shadow-2xl bg-card/95 backdrop-blur-xl">
        <DialogHeader className="space-y-3 pb-6 border-b border-border/50 bg-gradient-to-br from-chart-1/20 via-chart-1/10 to-transparent -mx-6 -mt-6 px-6 pt-6 rounded-t-lg">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-chart-1/20 rounded-lg">
              <Wrench className="h-6 w-6 text-chart-1" />
            </div>
            <div>
              <DialogTitle className="text-2xl font-bold bg-gradient-to-r from-chart-1 via-primary to-chart-1 bg-clip-text text-transparent">
                Edit Maintenance Request
              </DialogTitle>
              <DialogDescription className="text-base mt-1">
                Update maintenance task details and progress
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-200px)] px-1">
          <form
            action={async (formData) => {
              await updateMaintenanceRequest(formData)
              setOpen(false)
            }}
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div className="grid gap-6 md:grid-cols-2 p-5 bg-gradient-to-br from-primary/5 to-transparent rounded-lg border border-primary/10">
                ...
                <div className="space-y-2.5">
                  ...
                  <Select name="equipment_id" defaultValue={request.equipment_id.toString()} required>
                ...
                <div className="space-y-2.5">
                  ...
                  <Select name="priority" defaultValue={request.priority} required>
                    <SelectTrigger className="h-12 border-border/50 hover:border-primary/50 transition-all bg-background/50 hover:bg-background/80">
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div className="grid gap-6 md:grid-cols-2 p-5 bg-gradient-to-br from-chart-2/5 to-transparent rounded-lg border border-chart-2/10">
                <div className="space-y-2.5">
                  ...
                  <Input
                    ...
                    name="due_date"
                    type="date"
                    defaultValue={request.due_date ? new Date(request.due_date).toISOString().split("T")[0] : ""}
                    className="h-12 border-border/50 hover:border-primary/50 focus:border-primary transition-colors bg-background/50"
                  />
                </div>
                ...
                <div className="space-y-2.5">
                  <Label htmlFor="actual_cost" className="text-sm font-semibold flex items-center gap-2">
                    <DollarSign className="h-3.5 w-3.5" />
              ...
              <div className="grid gap-6 md:grid-cols-2 p-5 bg-gradient-to-br from-accent/10 to-transparent rounded-lg border border-accent/20">
                <div className="flex items-center space-x-3 p-2">
                  <input
                    ...
                    id="is_recurring"
                    name="is_recurring"
                    defaultChecked={request.is_recurring}
                ...
                <div className="space-y-2.5">
                  ...
                  <Select name="frequency" defaultValue={request.frequency || "None"}>
                    <SelectTrigger className="h-12 border-border/50 hover:border-primary/50 transition-all bg-background/50 hover:bg-background/80">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-card/95 backdrop-blur-xl border-primary/20">
            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-border/50 sticky bottom-0 bg-card/95 backdrop-blur-sm -mx-1 px-1 pb-1">
              ...
              <Button
                type="submit"
                className="h-12 px-8 bg-gradient-to-r from-chart-1 via-primary to-chart-1 bg-[length:200%_100%] hover:bg-[position:100%_0] transition-all duration-500 shadow-lg hover:shadow-xl hover:shadow-chart-1/50"
              >
